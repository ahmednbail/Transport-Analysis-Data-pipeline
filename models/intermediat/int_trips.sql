...
cleaned_and_enriched as (
    select
        ...
        {{ dbt_utils.generate_surrogate_key(['u.vendor_id', 'u.pickup_datetime', 'u.pickup_location_id', 'u.dropoff_location_id']) }} as trip_id,
...
-- Deduplicate: if multiple trips match (same vendor, second, location , dropoff_location_id), keep first
qualify row_number() over(
    partition by vendor_id, pickup_datetime, pickup_location_id, dropoff_location_id
